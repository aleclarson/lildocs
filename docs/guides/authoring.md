...
to fill the viewport. Diagram colors come from the active Shiki theme and follow
configured light and dark themes. Invalid Mermaid syntax fails the build
